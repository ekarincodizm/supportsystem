...
<script type="text/javascript" src="<?php echo base_url()?>js/jquery-1.11.1.min.js"></script>
 ...
 <script>
	$(document).ready(function(){
		$('.content').load("<?php echo base_url()?>index.php/MemberCon/addView");
 ...
 <body>
 <p class="ss">
<a class="submenu" href="<?php echo base_url();?>index.php/MemberCon/addView">ADD</a><br>
<a class="fancyboxMini" href="<?php echo base_url();?>index.php/MemberCon/addView">ADDPOPUP</a>
DELETE
