...
<form action="<?php echo base_url();?>index.php/Mobile/checkLogin" method="post"  data-ajax="false" >

Username :<input type="text" name="user" placeholder="ชื่อเข้าใช้งาน">

Password :<input type="text" name="pass" placeholder="รหัสผ่าน">
