...
<ul>
   ...
   <li><a href='<?php echo base_url()?>index.php/MemberCon/test' class="menu"><span>จัดการโควต้า</span></a></li>
    <li class='active has-sub'><a href='<?php echo base_url()?>index.php/MemberCon/test' class="menu"><span>สรุปการรับซื้อ</span></a>
      <ul>
         <li class='has-sub'><a href='<?php echo base_url()?>index.php/MemberCon/test' class="menu"><span>กำหนดราคา</span></a>
