...
<ul>
   ...
   <li><a href='<?php echo base_url()?>index.php/CustomerCon/showInvoiceResult' class="menu"><span>ออกใบเสร็จ</span></a></li>
    <li class='active has-sub'><a href='<?php echo base_url()?>index.php/CustomerCon/addInvoiceViewCus' class="menu"><span>จัดการการรับซื้อ</span></a>
   </li>
</ul>
</div>
<div id="content"></div>
